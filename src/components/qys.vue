<template>
    <div class="echarts">
        <div style="width:100;height:100%" ref="qys"></div>
        <div class="mapChoose">
    ...
    export default {
        ...
        methods: {
            ...
            initEcharts(mapData, pointData, sum, data_len) {
                ...
                this.myChart = echarts.init(this.$refs.qys)
                            ...
                            feature: {
                                ...
                                dataView: {
                                    optionToContent: function (opt) {
                                        ...
                                        let tdHeads =
                                            '<th  style="padding: 0 20px">地区</th><th style="padding: 0 20px">抽查企业数</th>' //表头
                                        let tdBodys = '' //数据
                                        let table =
                              ...
                              <td style="padding: 0 50px">${series[i].value.toFixed(2)}家</td>
                              </tr>`
                                        }
                                        table += '</tbody></table>'
                                        return table
                                ...
                                saveAsImage: {
                                    name: this.parentInfo[this.parentInfo.length - 1].cityName + '抽查企业数统计图'
                                },
                                dataZoom: {
                                    show: false
                                },
                        ...
                        geo: {
                            ...
                            tooltip: {
                                ...
                                formatter: (p) => {
                                    ...
                                    let txtCon =
                                        "<div style='text-align:left'>" + p.name + ":<br />抽查企业数：" + val.toFixed(
                                            2) + '家</div>';
                                    return txtCon;
                                }
                            },
                ...
                this.timeTitle.forEach(item => {
                    ...
                    option.options.push({
                        title: [{
                            ...
                            {
                                text: "抽查企业总数：" + (sum[item]).toFixed(0) + '家',
                                left: 'center',
                                top: '6.5%',
                                textStyle: {
                                    color: '#FFAC50',
