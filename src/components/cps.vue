<template>
    <div class="echarts">
        <div style="width:100;height:100%" ref="cps"></div>
        <div class="mapChoose">
                            ...
                            feature: {
                                ...
                                dataView: {
                                    optionToContent: function (opt) {
                                        ...
                                        let tdHeads =
                                            '<th  style="padding: 0 20px">地区</th><th style="padding: 0 20px">合格产品数</th>' //表头
                                        let tdBodys = '' //数据
                                        let table =
                              ...
                              <td style="padding: 0 50px">${series[i].value.toFixed(2)}%</td>
                                ...
                                saveAsImage: {
                                    name: this.parentInfo[this.parentInfo.length - 1].cityName + '合格产品数统计图'
                                },
                                dataZoom: {
                                    show: false
                                },
                        ...
                        geo: {
                            ...
                            tooltip: {
                                ...
                                formatter: (p) => {
                                    ...
                                    let txtCon =
                                        "<div style='text-align:left'>" + p.name + ":<br />合格产品数：" + val.toFixed(
                                            2) + '%</div>';
                                    return txtCon;
                                }
                            },
                ...
                this.timeTitle.forEach(item => {
                    ...
                    option.options.push({
                        title: [{
                            ...
                            {
                                text: "合格产品总数：" + (sum[item]/data_len[item]).toFixed(0) + '批次',
                                left: 'center',
                                top: '6.5%',
                                textStyle: {
                                    color: '#FFAC50',
